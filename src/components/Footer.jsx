...
const Footer = () => {
  return (
    <>
      ...
      {/* Footer Top */}
      <footer className="main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20 max-md:text-center">
        <Link className="max-md:text-center" to="/">
          <img
            src={Logo}
            alt="Logo"
            className="h-10 w-auto max-md:mx-auto max-md:mb-5"
          />
        </Link>
        <div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-base lg:text-lg">
            <li>bhattprince305@gmail.com</li>
            <li>+91 84378 38230</li>
          </ul>
        </div>
      </footer>
      ...
      <div className="main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center">
        <div className="text-base lg:text-lg">
          © 2025 PB | All rights reserved
        </div>
        <div className="flex gap-3 justify-center md:justify-end">
          <a
            href="https://www.linkedin.com/in/prince-bhatt-a79660198"
            target="_blank"
          >
            <svg
              width="30"
          ...
          <a href="https://www.instagram.com/_princebhatt_" target="_blank">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <a href="https://github.com/princebhatt07" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
